  ...
  module TransactionSets
    module ThirtyTen
      module Implementations
        ...
        FA997 = b.build("FA", "997", "Response to a Load Trailer",
          d::TableDef.header("Heading",
            ...
            d::LoopDef.build("AK2", d::RepeatCount.bounded(999999),
              b::Segment(30, s::AK2, "Transaction Set Response Header", r::Required, d::RepeatCount.bounded(1),
                b::Element(e::Required,    "Transaction Set Identifier Code"),
                b::Element(e::Required,    "Transaction Set Control Number")),

              d::LoopDef.build("AK3", d::RepeatCount.bounded(999999),
                b::Segment( 40, s::AK3, "Data Segment Note", r::Required, d::RepeatCount.bounded(1),
                  ...
                  b::Element(e::Situational, "Segment Syntax Error Code"),
                  b::Element(e::Situational, "Segment Syntax Error Code")),
                b::Segment( 50, s::AK4, "Data Segment Note", r::Required, d::RepeatCount.bounded(99),
