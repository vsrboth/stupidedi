  ...
  module TransactionSets
    module ThirtyTen
      module Implementations
        ...
        RA820 = b.build("RA", "820", "Ship Notice/Manifest",
          d::TableDef.header("Heading",
            ...
            d::LoopDef.build("N1", d::RepeatCount.bounded(1),
              b::Segment(70, s:: N1, "Name", r::Required, d::RepeatCount.bounded(1),
                ...
                b::Element(e::Required,    "Name - Supplier Contact"),
                b::Element(e::NotUsed,     "Unknown"),
                b::Element(e::NotUsed,     "Unknown")))),
            d::LoopDef.build("N1 - 2", d::RepeatCount.bounded(1),
              b::Segment(75, s:: N1, "Name", r::Required, d::RepeatCount.bounded(1),
                b::Element(e::Required,    "Entity Identifier Code", b::Values("PR")),
                b::Element(e::Required,    "Name - Free Form Name"),
                b::Element(e::NotUsed,     "Unknown"),
                b::Element(e::NotUsed,     "Unknown")))),
            d::LoopDef.build("PER", d::RepeatCount.bounded(1),
              b::Segment(120, s::PER, "Administrative Communications Contact", r::Situational, d::RepeatCount.bounded(1),
                b::Element(e::Required,    "Contact Function Code", b::Values("ZZ")),
                b::Element(e::Situational, "Name - Free Form Name"),
            ...
            d::LoopDef.build("N1", d::RepeatCount.bounded(10000),
              ...
              d::LoopDef.build("RMT", d::RepeatCount.unbounded,
                b::Segment( 30, s::RMT, "Remittance Advice", r::Situational, d::RepeatCount.bounded(1),
                  b::Element(e::Required,    "Reference Number Qualifier", b::Values("TJ")),
              ...
              d::LoopDef.build("N1 - 5", d::RepeatCount.bounded(10000),
